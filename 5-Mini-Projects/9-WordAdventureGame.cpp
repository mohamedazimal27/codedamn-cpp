/*
Text Adventure Game
Create a simple text adventure game with multiple paths and outcomes. 
The game should prompt the user to make choices at various decision points, 
and the outcome of the game should depend on their choices.
*/
